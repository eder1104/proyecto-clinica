            ...
            <div class="modal-container">
                <form action="{{ route('pacientes.update', $paciente) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombres" id="nombres" class="input-field"
                               value="{{ old('nombres', $paciente->nombres) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="apellidos">Apellidos</label>
                        <input type="text" name="apellidos" id="apellidos" class="input-field"
                               value="{{ old('apellidos', $paciente->apellidos) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="documento">Documento</label>
                        <input type="text" name="documento" id="documento" class="input-field"
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="input-field"
